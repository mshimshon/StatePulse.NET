...
## v3.1.0
### New Features
- You can now define type service registration like `services.AddStatePulseServices(o=>{o.RegisterTypeOf<MyAction>().RegisterTypeOf<MyDoneAction>(); })`. 
- You can now define type assembly scan service registration like `services.AddStatePulseServices(o=>{o.ScanAssemblyTypeOf<MYTYPE>().ScanAssemblyTypeOf<MYOTHERASSEMBLYTYPE>(); })`. 
